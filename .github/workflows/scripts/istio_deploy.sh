...
mesheryctl mesh deploy adapter meshery-istio:10000 --token "./.github/workflows/auth.json"
echo "Onboarding application... Standby for few minutes..."
mesheryctl app onboard -f "https://raw.githubusercontent.com/istio/istio/blob/master/samples/bookinfo/platform/kube/bookinfo.yaml" --token "./.github/workflows/auth.json"
